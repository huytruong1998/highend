      ...
      <header className="header">
        ...
        <nav className={'nav ' + (addSticky === true ? 'sticky' : '')}>
          <ul>
            ...
            <li>
              <a href="javscript:void(0);">features</a>
            </li>
            <li>
              <a href="javscript:void(0);">team</a>
            </li>
            <li>
              <a href="javscript:void(0);">work</a>
            </li>
            <li className="logo">
            ...
            <li>
              <a href="javscript:void(0);">pricing</a>
            </li>
            <li>
              <a href="javscript:void(0);">client</a>
            </li>
            <li>
